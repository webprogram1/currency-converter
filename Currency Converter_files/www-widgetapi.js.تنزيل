...
;var eb;function fb(){var a=E.MessageChannel;typeof a==="undefined"&&typeof window!=="undefined"&&window.postMessage&&window.addEventListener&&!M("Presto")&&(a=function(){var f=db();f.style.display="none";document.documentElement.appendChild(f);var k=f.contentWindow;f=k.document;f.open();f.close();var e="callImmediate"+Math.random(),g=k.location.protocol=="file:"?"*":k.location.protocol+"//"+k.location.host;f=G(function(h){if((g=="*"||h.origin==g)&&h.data==e)this.port1.onmessage()},this);
...
Nb.yt_embedsEnableIframeApiSendFullEmbedUrl&&(window.location.href&&(e.forigin=window.location.href),(b=window.location.ancestorOrigins)&&b.length>0&&(e.aorigins=Array.from(b).join(",")),window.document.referrer&&(e.gporigin=window.document.referrer));a=""+X(a.h,"host")+("/embed/"+X(a.h,"videoId"))+"?"+ub(e);Nb.yt_embedsEnableIframeSrcWithIntent?(bb(c,Ya(a)),c.sandbox.add("allow-presentation","allow-top-navigation")):c.src=a;return c}
